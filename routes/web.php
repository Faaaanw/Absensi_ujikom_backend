...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    // Pastikan ini ada di dalam group Admin middleware
Route::get('/admin/employees/{id}/salary-detail', [\App\Http\Controllers\EmployeeController::class, 'getSalaryDetail'])->name('admin.employees.salary-detail');
